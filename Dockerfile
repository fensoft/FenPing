...
FROM ubuntu:26.04
ARG DEBIAN_FRONTEND=noninteractive
RUN apt-get update && apt-get install -y --no-install-recommends cron nano apache2 mariadb-server mariadb-client libapache2-mod-php php-mysql dnsmasq-base libxml-xpath-perl nmap iputils-ping iputils-arping net-tools php-curl sudo iptables syslog-ng && apt-get clean && rm -rf /var/lib/apt/lists/* /var/www/html/index.html
...
COPY favicon.ico favicon-32x32.png functions.php api.php cli.php database.php hosts.php scans.php inventory.php dnsmasq.conf.template ping.php config.php.template dnsmasq.leases.php db.sql /var/www/html/
