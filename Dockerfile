...
RUN install -d -o www-data -g www-data /var/lib/fenping/netboot \
    ...
    && touch /etc/dnsmasq.d/fenping.dhcp-hosts /etc/dnsmasq.d/fenping.dhcp-opts /etc/dnsmasq.d/fenping.hosts /etc/dnsmasq.d/fenping.dns-overrides /var/lib/misc/dnsmasq.leases \
    && printf '%s\n' \
