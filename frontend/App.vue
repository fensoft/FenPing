      ...
      <aside class="app-sidebar">
        ...
        <nav class="app-nav" :aria-label="t('Primary navigation')">
          ...
          <div class="app-nav-group app-nav-bottom">
            ...
            <button v-if="isAuthenticated" class="app-nav-link" :class="{ active: route.name === routeNames.doctor }" type="button" :title="t('Doctor')" :aria-current="route.name === routeNames.doctor ? 'page' : undefined" @click="go('/doctor')"><AppIcon name="stethoscope" /><span>{{ t('Doctor') }}</span></button>
          </div>
