      ...
      <aside class="app-sidebar">
        ...
        <nav class="app-nav" :aria-label="t('Primary navigation')">
          ...
          <div class="app-nav-group app-nav-bottom">
            ...
            <button class="app-nav-link" :class="{ active: route.name === routeNames.dns }" type="button" title="DNS" :aria-current="route.name === routeNames.dns ? 'page' : undefined" @click="go('/dns')"><AppIcon name="world-www" /><span>DNS</span></button>
            ...
            <button v-if="isAuthenticated" class="app-nav-link" :class="{ active: route.name === routeNames.audit }" type="button" :title="t('Audit log')" :aria-current="route.name === routeNames.audit ? 'page' : undefined" @click="go('/audit')"><AppIcon name="history" /><span>{{ t('Audit log') }}</span></button>
