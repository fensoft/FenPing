...
final class ApiKernelTest extends IntegrationTestCase
{
    ...
    public function testNativeRouteManifestRemainsStable(): void
    {
        ...
        $expected = [
            ...
            'GET /backups/{filename}/file session ',
            'GET /services guest ', 'POST /services/pins session services',
            'DELETE /services/pins/{id:int} session services', 'POST /services/manual session services',
            'PUT /services/manual/{id:int} session services', 'DELETE /services/manual/{id:int} session services',
            'POST /services/manual/{id:int}/check session services',
            'GET /scans guest ', 'GET /scans/profiles guest ', 'POST /scans/{ip:ipv4} session scans',
