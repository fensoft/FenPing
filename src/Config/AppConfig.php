...
final readonly class AppConfig
{
    ...
    public function __construct(
        ...
        public int $statusHistoryRetentionDays = 365,
        public int $statusHistoryMaxEventsPerIp = 1000,
    ...
    public static function fromEnvironment(string $projectDir): self
    {
        ...
        return new self(
            ...
            statusHistoryRetentionDays: self::positiveIntEnv('STATUS_HISTORY_RETENTION_DAYS', 365),
            statusHistoryMaxEventsPerIp: self::positiveIntEnv('STATUS_HISTORY_MAX_EVENTS_PER_IP', 1000),
