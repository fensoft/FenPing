...
final readonly class BackupController implements Controller
{
    ...
    {
        return [
            new Route('GET', '/backups', fn(array $params): array => $this->backups->apiList(), AuthPolicy::Session),
            new Route('GET', '/backups/{filename}/file', function (array $params): FileResponse {
                try {
